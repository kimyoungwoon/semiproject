...
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/writing/reviewer/data/style.css" />
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/writing/reviewer/data/newstyle.css" />
	...
	<div class="container">
		<form action="" method="post" name="myForm"
			...
			<table width="600" border="0px" style="margin: auto;">
				...
				<tr height="10">
					<td align="right" colspan="2" bgcolor="#FCF8E8"><input
						type="button" class="btn2" value="Registration" onclick="sendIt()" />
						<input type="reset" class="btn2" value="Re-enter"
						onclick="document.myForm.name.focus();" /></td>
				</tr>
			...
			<table width="600" border="0" cellspacing="0" cellpadding="5"
				...
				<c:forEach var="dto" items="${lists }">
					...
					<tr height="250">
						<td align="center" width="190"><input type="hidden"
							value="${dto.num }" name="num" /> <a
							href="${imagePath }/${dto.saveFileName }"> <img
								src="${imagePath }/${dto.saveFileName}" width="180" height="180"><br /></a>
