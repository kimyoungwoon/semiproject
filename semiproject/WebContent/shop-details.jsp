...
<input type="hidden" id="iProductNum"
	value="<%=request.getParameter("productNum")%>" />
...
<body>
					...
					<div class="col-lg-8">
						<div class="product__details__text">
							...
							<div class="product__details__cart__option">
								...
								<a href="javascript:insertCartFunction();" class="primary-btn">add
									to cart</a>
							</div>
	...
	<section>
		<br /> <br />
		<form
			action="<%=cp%>/review/write_ok.do?detailNum=${dto.num}&member=${sessionScope.customInfo.num}&productNum=<%=request.getParameter("productNum")%>"
				...
				<c:choose>
					<c:when test="${empty sessionScope.customInfo.id }">
						<div class="container">
							<div class="col-lg-12">
								<div class="row">
									<textarea style="margin: auto;" rows="8" cols="140"
										name="content" disabled="disabled">로그인시 이용 가능합니다</textarea>
								</div>
								<div style="margin: auto;" class="row">
									<button type="button" class="btn btn-outline-dark btn-lg">
										<h6>
											<label for="input-file">파일업로드</label> <input type="file"
												id="input-file" style="display: none;" name="imageFile" />
										</h6>
									</button>
									<button style="margin-left: 864px" type="button"
										class="btn btn-outline-dark btn-lg">
										<h6>
											<label for="input-review">리뷰등록하기</label> <input type="submit"
												id="input-review" style="display: none;" />
										</h6>
									</button>
								</div>
							</div>
									...
									<div class="col1">
										<p>
											<a class="btn btn-dark" data-bs-toggle="collapse"
												href="#collapseExample${number }" role="button"
								...
								<div class="row">
									...
									<div style="margin-left: 650px" class="col">
										<dd class="deletebutton">
											<a
												href="<%=cp%>/review/delete.do?num=${dto.num }&productNum=<%=request.getParameter("productNum")%>">delete</a>
										</dd>
									</div>
								</div>
							</div>
