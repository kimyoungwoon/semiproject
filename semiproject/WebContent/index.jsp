   ...
   <%@include file = "payment/nav.jsp"  %>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="<%=cp%>/img/hero/hero-1.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="<%=cp%>/img/hero/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="<%=cp%>/img/banner/banner-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="<%=cp%>/img/banner/banner-2.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="<%=cp%>/img/banner/banner-3.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="<%=cp%>/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="<%=cp%>/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="<%=cp%>/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="<%=cp%>/img/icon/search.png" alt=""></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="<%=cp%>/img/product-sale.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-1.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-2.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-3.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-4.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-5.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="<%=cp%>/img/instagram/instagram-6.jpg"></div>
                    </div>
                </div>
                <div class="col-lg-4">
