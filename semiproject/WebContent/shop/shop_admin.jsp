...
<tr><td colspan="2" height="1" bgcolor="#dbdbdb" align="center"></td></tr>
	<tr>
		...
		<td width="600" style="padding-left: 10px;" bgcolor="#eeeeee">
		<input type="text" name="pd_categoryNum" size="48" maxlength="100" class="boxTF"/>
		</td>
	</tr>
<tr><td colspan="2" height="e" bgcolor="#dbdbdb" align="center"></td></tr>
<tr><td colspan="2" height="1" bgcolor="#dbdbdb" align="center"></td></tr>
	<tr>
		...
		<td width="600" style="padding-left: 10px;" bgcolor="#eeeeee">
		<input type="text" name="pd_brandNum" size="48" maxlength="100" class="boxTF"/>
		</td>
	</tr>
<tr><td colspan="2" height="e" bgcolor="#dbdbdb" align="center"></td></tr>
<tr><td colspan="2" height="1" bgcolor="#dbdbdb" align="center"></td></tr>
	<tr>
		...
		<td width="600" style="padding-left: 10px;" bgcolor="#eeeeee">
		<input type="text" name="upload" size="48" maxlength="100" class="boxTF"/>
		</td>
	</tr>
<tr><td colspan="2" height="e" bgcolor="#dbdbdb" align="center"></td></tr>
<tr><td colspan="2" height="1" bgcolor="#dbdbdb" align="center"></td></tr>
